"use client";
import { FullConversationType } from "@/temp_app/types";
import { useEffect, useMemo, useState } from "react";
import { useRouter } from "next/navigation";
import useConversation from "@/temp_app/hooks/useConversation";
import clsx from "clsx";
import { MdOutlineGroupAdd } from "react-icons/md";
import ConversationItem from "@/temp_app/conversations/components/ConversationItem";
import { pusherClient } from "@/lib/pusher";
import EmptyConversationList from "@/temp_app/conversations/components/EmptyConversationList";
import { TypingHandlerProps } from "@/temp_app/conversations/[conversationId]/components/TypingContainer";
    ...
    >
      <div className="px-5">
        <div className="mb-4 flex justify-between pt-4">
          ...
          <div className="cursor-pointer rounded-full bg-gray-100 p-2 text-black transition hover:bg-gray-200">
